...
import systemUsersController from "../controllers/systemUsersController.js";
const router = express.Router();

router
  .get("/users", systemUsersController.listar)
  .get("/users/:id", systemUsersController.listarPorID)
  .post("/users", systemUsersController.inserir)
  .patch("/users/:id", systemUsersController.atualizar)
  .delete("/users/:id", systemUsersController.excluir)
