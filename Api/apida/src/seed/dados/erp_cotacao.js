...
/* 
	Gerar contaçoes 
	Para cada 1/3 das contações gerar compras. 
	Os items das compras devem ser os mesmos das cotações
	Para cada compra gerar um pagamento, mas apenas se o status da compra for "Aguardando pagamento"
